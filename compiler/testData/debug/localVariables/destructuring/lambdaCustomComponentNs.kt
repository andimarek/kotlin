...
// test.kt:16 $box: (26, 4)
// test.kt:13 $foo: $a:(ref $MyPair)=(ref $MyPair), $block:(ref $kotlin.test.Function1)=(ref $kotlin.test.Function1) (56, 62, 56, 56, 56, 56, 56, 56, 56, 56, 56)
// test.kt:16 $box$lambda.invoke: $x:(ref null $kotlin.String)=null, $y:(ref null $kotlin.String)=null (26, 26, 29, 29)
// test.kt:5 $MyPair.component1: $<this>:(ref $MyPair)=(ref $MyPair) (15, 15, 15, 8)
// test.kt:16 $box$lambda.invoke: $x:(ref $kotlin.String)=(ref $kotlin.String), $y:(ref null $kotlin.String)=null (29, 32, 32)
// test.kt:9 $MyPair.component2: $<this>:(ref $MyPair)=(ref $MyPair) (15, 15, 15, 8)
// test.kt:16 $box$lambda.invoke: $x:(ref $kotlin.String)=(ref $kotlin.String), $y:(ref $kotlin.String)=(ref $kotlin.String) (32, 38, 42, 38, 43)
// test.kt:13 $foo: $a:(ref $MyPair)=(ref $MyPair), $block:(ref $kotlin.test.Function1)=(ref $kotlin.test.Function1) (56, 56, 56, 56, 56, 56, 56, 56, 56, 64)
// test.kt:16 $box: (4)
// test.kt:17 $box: (1)
