...
// test.kt:18 $box: (4)
// test.kt:17 $box: (4)
// test.kt:14 $foo: $a:(ref $MyPair)=(ref $MyPair), $block:(ref $kotlin.test.Function1)=(ref $kotlin.test.Function1) (56, 62, 56, 56, 56, 56, 56, 56, 56, 56, 56)
// test.kt:18 $box$lambda.invoke: $x:(ref null $kotlin.String)=null, $y:(ref null $kotlin.String)=null (4, 4)
// test.kt:20 $box$lambda.invoke: $x:(ref null $kotlin.String)=null, $y:(ref null $kotlin.String)=null (16, 16)
// test.kt:6 $MyPair.component1: $<this>:(ref $MyPair)=(ref $MyPair) (15, 15, 15, 8)
// test.kt:20 $box$lambda.invoke: $x:(ref null $kotlin.String)=null, $y:(ref null $kotlin.String)=null (16)
// test.kt:22 $box$lambda.invoke: $x:(ref $kotlin.String)=(ref $kotlin.String), $y:(ref null $kotlin.String)=null (16, 16)
// test.kt:10 $MyPair.component2: $<this>:(ref $MyPair)=(ref $MyPair) (15, 15, 15, 8)
// test.kt:22 $box$lambda.invoke: $x:(ref $kotlin.String)=(ref $kotlin.String), $y:(ref null $kotlin.String)=null (16)
// test.kt:25 $box$lambda.invoke: $x:(ref $kotlin.String)=(ref $kotlin.String), $y:(ref $kotlin.String)=(ref $kotlin.String) (8, 12, 8, 13)
// test.kt:14 $foo: $a:(ref $MyPair)=(ref $MyPair), $block:(ref $kotlin.test.Function1)=(ref $kotlin.test.Function1) (56, 56, 56, 56, 56, 56, 56, 56, 56, 64)
// test.kt:17 $box: (4)
// test.kt:27 $box: (1)
