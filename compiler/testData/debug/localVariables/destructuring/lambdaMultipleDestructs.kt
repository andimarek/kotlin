...
// test.kt:8 $box: (34, 4)
// test.kt:5 $foo: $a:(ref $A)=(ref $A), $b:(ref $A)=(ref $A), $block:(ref $kotlin.coroutines.Function2)=(ref $kotlin.coroutines.Function2) (55, 61, 64, 55, 55, 55, 55, 55, 55, 55, 55, 55)
// test.kt:8 $box$lambda.invoke: $x:(ref $kotlin.String)=(ref $kotlin.String), $y:i32=123:i32, $z:(ref $kotlin.String)=(ref $kotlin.String), $w:i32=877:i32 (34, 34, 34, 34, 34, 34, 37, 37, 37, 40, 40, 40, 45, 45, 45, 48, 48, 48, 55, 59, 55, 65, 65, 65, 65, 65, 69, 65, 65, 54, 71)
// test.kt:5 $foo: $a:(ref $A)=(ref $A), $b:(ref $A)=(ref $A), $block:(ref $kotlin.coroutines.Function2)=(ref $kotlin.coroutines.Function2) (55, 55, 55, 55, 55, 55, 55, 55, 55, 66)
// test.kt:8 $box: (4)
// test.kt:9 $box: (1)
