...
// test.kt:8 $box$lambda.invoke: $$this$blockFun:(ref $kotlin.String)=(ref $kotlin.String) (14, 14)
// test.kt:9 $box$lambda.invoke: $$this$blockFun:(ref $kotlin.String)=(ref $kotlin.String) (18, 18, 18)
// test.kt:8 $box$lambda.invoke: $$this$blockFun:(ref $kotlin.String)=(ref $kotlin.String) (14)
// test.kt:5 $blockFun: $blockArg:(ref $kotlin.test.Function1)=(ref $kotlin.test.Function1) (9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 19)
// test.kt:11 $box: (1)
